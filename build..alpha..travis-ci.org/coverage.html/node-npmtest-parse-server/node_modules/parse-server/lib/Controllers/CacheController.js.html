...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-parse-server/node_modules/parse-server/lib/Controllers/CacheController.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-parse-server/node_modules/parse-server/lib/Controllers/CacheController.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-parse-server/node_modules/parse-server/lib/Controllers/</a> &#187; CacheController.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function joinKeys() {</span>
<span class="cstat-no" title="statement not covered" >  for (var _len = arguments.length, keys = Array(_len), _key = 0; _key &lt; _len; _key++) {</span>
<span class="cstat-no" title="statement not covered" >    keys[_key] = arguments[_key];</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return keys.join(KEY_SEPARATOR_CHAR);</span>
}
&nbsp;
/**
...
<span class="fstat-no" title="function not covered" >  function SubCache(prefix, cacheController, ttl) {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, SubCache);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      var cacheKey = joinKeys(this.prefix, key);</span>
<span class="cstat-no" title="statement not covered" >      return this.cache.get(cacheKey);</span>
    }
  }, {
    key: 'put',
    value: <span class="fstat-no" title="function not covered" >function put(key, value, ttl) {</span>
<span class="cstat-no" title="statement not covered" >      var cacheKey = joinKeys(this.prefix, key);</span>
<span class="cstat-no" title="statement not covered" >      return this.cache.put(cacheKey, value, ttl);</span>
    }
  }, {
    key: 'del',
    value: <span class="fstat-no" title="function not covered" >function del(key) {</span>
<span class="cstat-no" title="statement not covered" >      var cacheKey = joinKeys(this.prefix, key);</span>
<span class="cstat-no" title="statement not covered" >      return this.cache.del(cacheKey);</span>
    }
  }, {
    key: 'clear',
    value: <span class="fstat-no" title="function not covered" >function clear() {</span>
<span class="cstat-no" title="statement not covered" >      return this.cache.clear();</span>
    }
  }]);
&nbsp;
  return SubCache;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function CacheController(adapter, appId) {</span>
<span class="cstat-no" title="statement not covered" >    var options = arguments.length &gt; 2 &amp;&amp; arguments[2] !== undefined ? arguments[2] : {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, CacheController);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _this = _possibleConstructorReturn(this, (CacheController.__proto__ || Object.getPrototypeOf(CacheController)).call(this, adapter, appId, options));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.role = new SubCache('role', _this);</span>
<span class="cstat-no" title="statement not covered" >    _this.user = new SubCache('user', _this);</span>
...
&nbsp;
  _createClass(CacheController, [{
    key: 'get',
    value: <span class="fstat-no" title="function not covered" >function get(key) {</span>
<span class="cstat-no" title="statement not covered" >      var cacheKey = joinKeys(this.appId, key);</span>
<span class="cstat-no" title="statement not covered" >      return this.adapter.get(cacheKey).then(null, <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >        return Promise.resolve(null);</span>
    ...
    value: <span class="fstat-no" title="function not covered" >function put(key, value, ttl) {</span>
<span class="cstat-no" title="statement not covered" >      var cacheKey = joinKeys(this.appId, key);</span>
<span class="cstat-no" title="statement not covered" >      return this.adapter.put(cacheKey, value, ttl);</span>
    }
  }, {
    key: 'del',
    value: <span class="fstat-no" title="function not covered" >function del(key) {</span>
<span class="cstat-no" title="statement not covered" >      var cacheKey = joinKeys(this.appId, key);</span>
<span class="cstat-no" title="statement not covered" >      return this.adapter.del(cacheKey);</span>
    }
  }, {
    key: 'clear',
    value: <span class="fstat-no" title="function not covered" >function clear() {</span>
<span class="cstat-no" title="statement not covered" >      return this.adapter.clear();</span>
    }
  }, {
    key: 'expectedAdapterType',
    value: <span class="fstat-no" title="function not covered" >function expectedAdapterType() {</span>
<span class="cstat-no" title="statement not covered" >      return _CacheAdapter2.default;</span>
    }
  }]);
&nbsp;

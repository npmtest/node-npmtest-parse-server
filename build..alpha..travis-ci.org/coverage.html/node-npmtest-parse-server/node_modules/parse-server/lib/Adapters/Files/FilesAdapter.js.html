...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-parse-server/node_modules/parse-server/lib/Adapters/Files/FilesAdapter.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-parse-server/node_modules/parse-server/lib/Adapters/Files/FilesAdapter.js</span></h1>
    <h2>
        
        Statements: <span class="metric">84% <small>(21 / 25)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-parse-server/node_modules/parse-server/lib/Adapters/Files/</a> &#187; FilesAdapter.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >  function FilesAdapter() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, FilesAdapter);</span>
  }
&nbsp;
...
&nbsp;
     ...
     *
     */
    value: <span class="fstat-no" title="function not covered" >function createFile(filename, data, contentType) {</span>}
  }, {
    key: "deleteFile",

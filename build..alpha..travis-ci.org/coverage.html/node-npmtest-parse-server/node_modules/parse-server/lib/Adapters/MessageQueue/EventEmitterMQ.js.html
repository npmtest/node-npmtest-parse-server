...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-parse-server/node_modules/parse-server/lib/Adapters/MessageQueue/EventEmitterMQ.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-parse-server/node_modules/parse-server/lib/Adapters/MessageQueue/EventEmitterMQ.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">55.56% <small>(25 / 45)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-parse-server/node_modules/parse-server/lib/Adapters/MessageQueue/</a> &#187; EventEmitterMQ.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function _unsubscribe(channel) {</span>
<span class="cstat-no" title="statement not covered" >  if (!subscriptions.has(channel)) {</span>
    //console.log('No channel to unsub from');
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
  //console.log('unsub ', channel);
<span class="cstat-no" title="statement not covered" >  emitter.removeListener(channel, subscriptions.get(channel));</span>
<span class="cstat-no" title="statement not covered" >  subscriptions.delete(channel);</span>
}
&nbsp;
var Publisher = function () {
<span class="fstat-no" title="function not covered" >  function Publisher(emitter) {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, Publisher);</span>
&nbsp;
...
&nbsp;
  _createClass(Publisher, [{
    key: 'publish',
    value: <span class="fstat-no" title="function not covered" >function publish(channel, message) {</span>
<span class="cstat-no" title="statement not covered" >      this.emitter.emit(channel, message);</span>
    }
  }]);
&nbsp;
  return Publisher;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function Consumer(emitter) {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, Consumer);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _this = _possibleConstructorReturn(this, (Consumer.__proto__ || Object.getPrototypeOf(Consumer)).call(this));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.emitter = emitter;</span>
<span class="cstat-no" title="statement not covered" >    return _this;</span>
  }
&nbsp;
  _createClass(Consumer, [{
    key: 'subscribe',
    value: <span class="fstat-no" title="function not covered" >function subscribe(channel) {</span>
<span class="cstat-no" title="statement not covered" >      var _this2 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      _unsubscribe(channel);</span>
<span class="cstat-no" title="statement not covered" >      var handler = <span class="fstat-no" title="function not covered" >function handler(message) {</span></span>
<span class="cstat-no" title="statement not covered" >        _this2.emit('message', channel, message);</span>
      };
<span class="cstat-no" title="statement not covered" >      subscriptions.set(channel, handler);</span>
<span class="cstat-no" title="statement not covered" >      this.emitter.on(channel, handler);</span>
    }
  }, {
    key: 'unsubscribe',
    value: <span class="fstat-no" title="function not covered" >function unsubscribe(channel) {</span>
<span class="cstat-no" title="statement not covered" >      _unsubscribe(channel);</span>
    }
  }]);
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >function createPublisher() {</span>
<span class="cstat-no" title="statement not covered" >  return new Publisher(emitter);</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function createSubscriber() {</span>
<span class="cstat-no" title="statement not covered" >  return new Consumer(emitter);</span>
}
&nbsp;
var EventEmitterMQ = {

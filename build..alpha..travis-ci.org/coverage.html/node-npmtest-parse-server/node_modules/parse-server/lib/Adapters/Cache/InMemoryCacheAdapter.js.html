...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-parse-server/node_modules/parse-server/lib/Adapters/Cache/InMemoryCacheAdapter.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-parse-server/node_modules/parse-server/lib/Adapters/Cache/InMemoryCacheAdapter.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-parse-server/node_modules/parse-server/lib/Adapters/Cache/</a> &#187; InMemoryCacheAdapter.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >  function InMemoryCacheAdapter(ctx) {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, InMemoryCacheAdapter);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.cache = new _InMemoryCache.InMemoryCache(ctx);</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        var record = _this.cache.get(key);</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        return resolve(JSON.parse(record));</span>
      });
    }
  }, {
    key: 'put',
    value: <span class="fstat-no" title="function not covered" >function put(key, value, ttl) {</span>
<span class="cstat-no" title="statement not covered" >      this.cache.put(key, JSON.stringify(value), ttl);</span>
...
<span class="cstat-no" title="statement not covered" >      this.cache.del(key);</span>
<span class="cstat-no" title="statement not covered" >      return Promise.resolve();</span>
    }
  }, {
    key: 'clear',

...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-parse-server/node_modules/parse-server/lib/Adapters/PubSub/EventEmitterPubSub.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-parse-server/node_modules/parse-server/lib/Adapters/PubSub/EventEmitterPubSub.js</span></h1>
    <h2>
        
        Statements: <span class="metric">80.6% <small>(54 / 67)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">54.29% <small>(19 / 35)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-parse-server/node_modules/parse-server/lib/Adapters/PubSub/</a> &#187; EventEmitterPubSub.js</div>
</div>
<div class="body">
...
&nbsp;
    var _this = _possibleConstructorReturn(this, (Subscriber.__proto__ || <span class="branch-1 cbranch-no" title="branch not covered" >Object.getPrototypeOf(Subscriber))</span>.call(this));
&nbsp;
...
&nbsp;
  _createClass(Subscriber, [{
    ...
    value: function subscribe(channel) {
      var _this2 = this;
&nbsp;
      var handler = <span class="fstat-no" title="function not covered" >function handler(message) {</span>
...
<span class="cstat-no" title="statement not covered" >      if (!this.subscriptions.has(channel)) {</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
<span class="cstat-no" title="statement not covered" >      this.emitter.removeListener(channel, this.subscriptions.get(channel));</span>
<span class="cstat-no" title="statement not covered" >      this.subscriptions.delete(channel);</span>
    }
  }]);
&nbsp;
  return Subscriber;

...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-parse-server/node_modules/parse-server/lib/Routers/CloudCodeRouter.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-parse-server/node_modules/parse-server/lib/Routers/CloudCodeRouter.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-parse-server/node_modules/parse-server/lib/Routers/</a> &#187; CloudCodeRouter.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function CloudCodeRouter() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, CloudCodeRouter);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (CloudCodeRouter.__proto__ || Object.getPrototypeOf(CloudCodeRouter)).apply(this, arguments));</span>
  }
&nbsp;
  _createClass(CloudCodeRouter, [{
    key: 'mountRoutes',
    value: <span class="fstat-no" title="function not covered" >function mountRoutes() {</span>
<span class="cstat-no" title="statement not covered" >      this.route('GET', '/cloud_code/jobs', CloudCodeRouter.getJobs);</span>
    }
  }], [{
    key: 'getJobs',
    value: <span class="fstat-no" title="function not covered" >function getJobs(req) {</span>
<span class="cstat-no" title="statement not covered" >      var config = req.config;</span>
<span class="cstat-no" title="statement not covered" >      var jobs = triggers.getJobs(config.applicationId) || {};</span>
<span class="cstat-no" title="statement not covered" >      return Promise.resolve({</span>
        response: Object.keys(jobs).map(<span class="fstat-no" title="function not covered" >function (jobName) {</span>

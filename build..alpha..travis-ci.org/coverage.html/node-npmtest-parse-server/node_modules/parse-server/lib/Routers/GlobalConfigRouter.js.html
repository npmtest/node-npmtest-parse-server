...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-parse-server/node_modules/parse-server/lib/Routers/GlobalConfigRouter.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-parse-server/node_modules/parse-server/lib/Routers/GlobalConfigRouter.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">50% <small>(18 / 36)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-parse-server/node_modules/parse-server/lib/Routers/</a> &#187; GlobalConfigRouter.js</div>
</div>
<div class="body">
...
&nbsp;
function _inherits(subClass, superClass) { <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof superClass !== "function" &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >superClass !== null)</span> { <span class="cstat-no" title="statement not covered" >throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); </span>} subClass.prototype = Object.create(superClass &amp;&amp; superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); <span class="missing-if-branch" title="else path not taken" >E</span>if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : <span class="branch-1 cbranch-no" title="branch not covered" >subClass.__proto__ = superClass;</span> } // global_config.js
&nbsp;
var GlobalConfigRouter = exports.GlobalConfigRouter = function (_PromiseRouter) {
  _inherits(GlobalConfigRouter, _PromiseRouter);
&nbsp;
<span class="fstat-no" title="function not covered" >  function GlobalConfigRouter() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, GlobalConfigRouter);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (GlobalConfigRouter.__proto__ || Object.getPrototypeOf(GlobalConfigRouter)).apply(this, arguments));</span>
  }
&nbsp;
  _createClass(GlobalConfigRouter, [{
    key: 'getGlobalConfig',
    value: <span class="fstat-no" title="function not covered" >function getGlobalConfig(req) {</span>
<span class="cstat-no" title="statement not covered" >      return req.config.database.find('_GlobalConfig', { objectId: "1" }, { limit: 1 }).then(<span class="fstat-no" title="function not covered" >function (results) {</span></span>
<span class="cstat-no" title="statement not covered" >        if (results.length != 1) {</span>
          // If there is no config in the database - return empty config.
<span class="cstat-no" title="statement not covered" >          return { response: { params: {} } };</span>
        }
<span class="cstat-no" title="statement not covered" >        var globalConfig = results[0];</span>
<span class="cstat-no" title="statement not covered" >        return { response: { params: globalConfig.params } };</span>
      });
    }
  }, {
    key: 'updateGlobalConfig',
    value: <span class="fstat-no" title="function not covered" >function updateGlobalConfig(req) {</span>
<span class="cstat-no" title="statement not covered" >      var params = req.body.params;</span>
      // Transform in dot notation to make sure it works
<span class="cstat-no" title="statement not covered" >      var update = Object.keys(params).reduce(<span class="fstat-no" title="function not covered" >function (acc, key) {</span></span>
<span class="cstat-no" title="statement not covered" >        acc['params.' + key] = params[key];</span>
<span class="cstat-no" title="statement not covered" >        return acc;</span>
      }, {});
<span class="cstat-no" title="statement not covered" >      return req.config.database.update('_GlobalConfig', { objectId: "1" }, update, { upsert: true }).then(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >        return { response: { result: true } };</span>
      });
    }
  }, {
    key: 'mountRoutes',
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.route('GET', '/config', <span class="fstat-no" title="function not covered" >function (req) {</span></span>
<span class="cstat-no" title="statement not covered" >        return _this2.getGlobalConfig(req);</span>
      });
<span class="cstat-no" title="statement not covered" >      this.route('PUT', '/config', middleware.promiseEnforceMasterKeyAccess, <span class="fstat-no" title="function not covered" >function (req) {</span></span>
<span class="cstat-no" title="statement not covered" >        return _this2.updateGlobalConfig(req);</span>
      });
    }
  }]);
&nbsp;

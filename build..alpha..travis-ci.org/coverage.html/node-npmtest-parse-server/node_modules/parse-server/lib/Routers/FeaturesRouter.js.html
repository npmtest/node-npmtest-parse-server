...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-parse-server/node_modules/parse-server/lib/Routers/FeaturesRouter.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-parse-server/node_modules/parse-server/lib/Routers/FeaturesRouter.js</span></h1>
    <h2>
        
        Statements: <span class="metric">66.67% <small>(38 / 57)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">78.26% <small>(18 / 23)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-parse-server/node_modules/parse-server/lib/Routers/</a> &#187; FeaturesRouter.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function FeaturesRouter() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, FeaturesRouter);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (FeaturesRouter.__proto__ || Object.getPrototypeOf(FeaturesRouter)).apply(this, arguments));</span>
  }
&nbsp;
  _createClass(FeaturesRouter, [{
    key: 'mountRoutes',
    value: <span class="fstat-no" title="function not covered" >function mountRoutes() {</span>
<span class="cstat-no" title="statement not covered" >      this.route('GET', '/serverInfo', middleware.promiseEnforceMasterKeyAccess, <span class="fstat-no" title="function not covered" >function (req) {</span></span>

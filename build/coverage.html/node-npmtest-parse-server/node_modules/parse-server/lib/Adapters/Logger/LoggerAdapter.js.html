...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-parse-server/node_modules/parse-server/lib/Adapters/Logger/LoggerAdapter.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-parse-server/node_modules/parse-server/lib/Adapters/Logger/LoggerAdapter.js</span></h1>
    <h2>
        
        Statements: <span class="metric">92% <small>(23 / 25)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-parse-server/node_modules/parse-server/lib/Adapters/Logger/</a> &#187; LoggerAdapter.js</div>
</div>
<div class="body">
...
&nbsp;
  _createClass(LoggerAdapter, [{
    key: "log",
    value: <span class="fstat-no" title="function not covered" >function log(level, message) /* meta */{</span>}
  }]);
&nbsp;

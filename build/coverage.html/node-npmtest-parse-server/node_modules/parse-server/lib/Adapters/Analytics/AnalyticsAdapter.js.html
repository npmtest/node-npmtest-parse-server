...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-parse-server/node_modules/parse-server/lib/Adapters/Analytics/AnalyticsAdapter.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-parse-server/node_modules/parse-server/lib/Adapters/Analytics/AnalyticsAdapter.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-parse-server/node_modules/parse-server/lib/Adapters/Analytics/</a> &#187; AnalyticsAdapter.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >  function AnalyticsAdapter() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, AnalyticsAdapter);</span>
  }
&nbsp;
...
&nbsp;
     ...
     */
    value: <span class="fstat-no" title="function not covered" >function appOpened(parameters, req) {</span>
...
&nbsp;
    ...
    key: "trackEvent",
    value: <span class="fstat-no" title="function not covered" >function trackEvent(eventName, parameters, req) {</span>
<span class="cstat-no" title="statement not covered" >      return Promise.resolve({});</span>
    }
  }]);
&nbsp;

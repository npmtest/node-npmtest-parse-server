...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-parse-server/node_modules/parse-server/lib/cli/utils/runner.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-parse-server/node_modules/parse-server/lib/cli/utils/runner.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-parse-server/node_modules/parse-server/lib/cli/utils/</a> &#187; runner.js</div>
</div>
<div class="body">
...
function logStartupOptions(options) {
  for (var key in options) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (key == "masterKey") {
<span class="cstat-no" title="statement not covered" >      value = "***REDACTED***";</span>
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if ((typeof value === "undefined" ? <span class="branch-0 cbranch-no" title="branch not covered" >"undefined" </span>: _typeof(value)) === 'object') {

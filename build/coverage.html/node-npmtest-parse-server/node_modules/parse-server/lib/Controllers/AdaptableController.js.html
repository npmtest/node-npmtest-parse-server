...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-parse-server/node_modules/parse-server/lib/Controllers/AdaptableController.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-parse-server/node_modules/parse-server/lib/Controllers/AdaptableController.js</span></h1>
    <h2>
        
        Statements: <span class="metric">85.71% <small>(48 / 56)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">55.88% <small>(19 / 34)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-parse-server/node_modules/parse-server/lib/Controllers/</a> &#187; AdaptableController.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >      throw new Error("Subclasses should implement expectedAdapterType()");</span>
    }
  }, {
    key: "validateAdapter",
...
<span class="cstat-no" title="statement not covered" >      return new _Config2.default(this.appId);</span>
    }
  }], [{
    key: "validateAdapter",
...
<span class="cstat-no" title="statement not covered" >        throw new Error(this.constructor.name + " requires an adapter");</span>
      }
&nbsp;
...
&nbsp;
      ...
      var mismatches = Object.getOwnPropertyNames(Type.prototype).reduce(function (obj, key) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (adapterType !== expectedType) {
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (Object.keys(mismatches).length &gt; 0) {
<span class="cstat-no" title="statement not covered" >        throw new Error("Adapter prototype don't match expected prototype", adapter, mismatches);</span>
      }
    }
  }]);
&nbsp;

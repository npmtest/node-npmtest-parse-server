...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-parse-server/node_modules/parse-server/lib/Controllers/AnalyticsController.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-parse-server/node_modules/parse-server/lib/Controllers/AnalyticsController.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-parse-server/node_modules/parse-server/lib/Controllers/</a> &#187; AnalyticsController.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function AnalyticsController() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, AnalyticsController);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (AnalyticsController.__proto__ || Object.getPrototypeOf(AnalyticsController)).apply(this, arguments));</span>
  }
&nbsp;
  _createClass(AnalyticsController, [{
    key: 'appOpened',
    value: <span class="fstat-no" title="function not covered" >function appOpened(req) {</span>
...
<span class="cstat-no" title="statement not covered" >        return _this2.adapter.appOpened(req.body, req);</span>
      }).then(<span class="fstat-no" title="function not covered" >function (response) {</span>
<span class="cstat-no" title="statement not covered" >        return { response: response || {} };</span>
...
<span class="cstat-no" title="statement not covered" >        return { response: {} };</span>
    ...
    key: 'trackEvent',
    value: <span class="fstat-no" title="function not covered" >function trackEvent(req) {</span>
<span class="cstat-no" title="statement not covered" >      var _this3 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return Promise.resolve().then(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >        return _this3.adapter.trackEvent(req.params.eventName, req.body, req);</span>
      }).then(<span class="fstat-no" title="function not covered" >function (response) {</span>
<span class="cstat-no" title="statement not covered" >        return { response: response || {} };</span>
      }).catch(<span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        return { response: {} };</span>
...
<span class="cstat-no" title="statement not covered" >      return _AnalyticsAdapter.AnalyticsAdapter;</span>
    }
  }]);
&nbsp;

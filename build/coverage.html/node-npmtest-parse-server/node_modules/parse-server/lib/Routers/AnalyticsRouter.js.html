...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-parse-server/node_modules/parse-server/lib/Routers/AnalyticsRouter.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-parse-server/node_modules/parse-server/lib/Routers/AnalyticsRouter.js</span></h1>
    <h2>
        
        Statements: <span class="metric">69.39% <small>(34 / 49)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-parse-server/node_modules/parse-server/lib/Routers/</a> &#187; AnalyticsRouter.js</div>
</div>
<div class="body">
...
&nbsp;
function _inherits(subClass, superClass) { <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof superClass !== "function" &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >superClass !== null)</span> { <span class="cstat-no" title="statement not covered" >throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); </span>} subClass.prototype = Object.create(superClass &amp;&amp; superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); <span class="missing-if-branch" title="else path not taken" >E</span>if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : <span class="branch-1 cbranch-no" title="branch not covered" >subClass.__proto__ = superClass;</span> } // AnalyticsRouter.js
&nbsp;
&nbsp;
<span class="fstat-no" title="function not covered" >function appOpened(req) {</span>
<span class="cstat-no" title="statement not covered" >  var analyticsController = req.config.analyticsController;</span>
<span class="cstat-no" title="statement not covered" >  return analyticsController.appOpened(req);</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function trackEvent(req) {</span>
<span class="cstat-no" title="statement not covered" >  var analyticsController = req.config.analyticsController;</span>
<span class="cstat-no" title="statement not covered" >  return analyticsController.trackEvent(req);</span>
}
&nbsp;
var AnalyticsRouter = exports.AnalyticsRouter = function (_PromiseRouter) {
  _inherits(AnalyticsRouter, _PromiseRouter);
&nbsp;
<span class="fstat-no" title="function not covered" >  function AnalyticsRouter() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, AnalyticsRouter);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (AnalyticsRouter.__proto__ || Object.getPrototypeOf(AnalyticsRouter)).apply(this, arguments));</span>
  }
&nbsp;
  _createClass(AnalyticsRouter, [{
    key: 'mountRoutes',
    value: <span class="fstat-no" title="function not covered" >function mountRoutes() {</span>
<span class="cstat-no" title="statement not covered" >      this.route('POST', '/events/AppOpened', appOpened);</span>
<span class="cstat-no" title="statement not covered" >      this.route('POST', '/events/:eventName', trackEvent);</span>
    }
  }]);
&nbsp;

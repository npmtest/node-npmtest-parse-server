...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-parse-server/node_modules/parse-server/lib/Routers/PurgeRouter.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-parse-server/node_modules/parse-server/lib/Routers/PurgeRouter.js</span></h1>
    <h2>
        
        Statements: <span class="metric">59.38% <small>(38 / 64)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-parse-server/node_modules/parse-server/lib/Routers/</a> &#187; PurgeRouter.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function PurgeRouter() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, PurgeRouter);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (PurgeRouter.__proto__ || Object.getPrototypeOf(PurgeRouter)).apply(this, arguments));</span>
  }
&nbsp;
  _createClass(PurgeRouter, [{
    key: 'handlePurge',
    value: <span class="fstat-no" title="function not covered" >function handlePurge(req) {</span>
<span class="cstat-no" title="statement not covered" >      return req.config.database.purgeCollection(req.params.className).then(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >        var cacheAdapter = req.config.cacheController;</span>
<span class="cstat-no" title="statement not covered" >        if (req.params.className == '_Session') {</span>
<span class="cstat-no" title="statement not covered" >          cacheAdapter.user.clear();</span>
        } else <span class="cstat-no" title="statement not covered" >if (req.params.className == '_Role') {</span>
<span class="cstat-no" title="statement not covered" >          cacheAdapter.role.clear();</span>
        }
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.route('DELETE', '/purge/:className', middleware.promiseEnforceMasterKeyAccess, <span class="fstat-no" title="function not covered" >function (req) {</span></span>
<span class="cstat-no" title="statement not covered" >        return _this2.handlePurge(req);</span>
      });
    }
  }]);
&nbsp;

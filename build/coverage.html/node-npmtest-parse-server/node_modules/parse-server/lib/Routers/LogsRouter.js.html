...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-parse-server/node_modules/parse-server/lib/Routers/LogsRouter.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-parse-server/node_modules/parse-server/lib/Routers/LogsRouter.js</span></h1>
    <h2>
        
        Statements: <span class="metric">55.71% <small>(39 / 70)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-parse-server/node_modules/parse-server/lib/Routers/</a> &#187; LogsRouter.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function LogsRouter() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, LogsRouter);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (LogsRouter.__proto__ || Object.getPrototypeOf(LogsRouter)).apply(this, arguments));</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.route('GET', '/scriptlog', middleware.promiseEnforceMasterKeyAccess, this.validateRequest, <span class="fstat-no" title="function not covered" >function (req) {</span></span>
<span class="cstat-no" title="statement not covered" >        return _this2.handleGET(req);</span>
      });
    }
  }, {
    key: 'validateRequest',
    value: <span class="fstat-no" title="function not covered" >function validateRequest(req) {</span>
<span class="cstat-no" title="statement not covered" >      if (!req.config || !req.config.loggerController) {</span>
<span class="cstat-no" title="statement not covered" >        throw new _node.Parse.Error(_node.Parse.Error.PUSH_MISCONFIGURED, 'Logger adapter is not available');</span>
      }
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      var from = req.query.from;</span>
<span class="cstat-no" title="statement not covered" >      var until = req.query.until;</span>
<span class="cstat-no" title="statement not covered" >      var size = req.query.size;</span>
<span class="cstat-no" title="statement not covered" >      if (req.query.n) {</span>
<span class="cstat-no" title="statement not covered" >        size = req.query.n;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      var order = req.query.order;</span>
<span class="cstat-no" title="statement not covered" >      var level = req.query.level;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      return req.config.loggerController.getLogs(options).then(<span class="fstat-no" title="function not covered" >function (result) {</span></span>
